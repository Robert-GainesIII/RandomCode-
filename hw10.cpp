...
//For question 5 the line will result in no data copied becasue of a conditional line of code that 
//Checks for self assignment This is the most efficent move semantics to use on an object like this.